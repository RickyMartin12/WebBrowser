Public Class Form1
    ...
    Private Sub tstbUrl_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Private Sub ToolStripButton7_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton7.Click
        ...
        CType(TabControl1.SelectedTab.Controls.Item(0), WebBrowser).Navigate("http://deei.fct.ualg.pt/~a44377/black/site/index.php")
    End Sub
    ...
    Private Sub tstbUrl_KeyPress(sender As Object, e As KeyPressEventArgs) Handles tstbUrl.KeyPress

    End Sub

    Private Sub tstbUrl_Click_1(sender As Object, e As EventArgs) Handles tstbUrl.Click
    ...
    Private Sub ToolStripButton8_Click(sender As Object, e As EventArgs) Handles ToolStripButton8.Click
        CType(TabControl1.SelectedTab.Controls.Item(0), WebBrowser).Navigate("http://deei.fct.ualg.pt/~a44377/temp/template/site/")
    End Sub
End Class
